...
-- enjoy :D
-- This uses neovim's built in package manager vim.pack
...
Plug('ellisonleao/gruvbox.nvim', { ['as'] = 'gruvbox' }) -- gruvbox
Plug('navarasu/onedark.nvim', { ['as'] = 'onedark' }) -- onedark
Plug('scottmckendry/cyberdream.nvim', { ['as'] = 'cyberdream' }) -- cyberdream
Plug('oxfist/night-owl.nvim', { ['as'] = 'night-owl' }) -- night-owl
